...
import '../../screens/whatsapp_status.dart';
...
class Browse extends StatelessWidget {
  refresh(BuildContext context) async {
    CoreProvider _coreProvider = Get.find();
    await _coreProvider.checkSpace();
  }
...
class _StorageSection extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return GetBuilder<CoreProvider>(
      builder: (CoreProvider coreProvider) {
